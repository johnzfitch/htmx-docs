# reset-user-input__98789463

- Source URL: https://htmx.org/examples/reset-user-input/
- Source file: `fetch/htmx_org_98789463.html`
- Hash: `98789463`
...
This example shows how to easily reset user inputs using [`hx-on`](https://htmx.org/attributes/hx-on/), allowing users to make multiple requests without having to manually delete their previous inputs.

The inline script will run on the [`afterRequest`](https://htmx.org/events/#htmx:afterRequest) event and ensures that the form will reset to its initial state as long as the response has a 20x status code:
