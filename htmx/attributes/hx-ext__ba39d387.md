...
- Source URL: https://htmx.org/attributes/hx-ext/
- Source file: `fetch/htmx_org_ba39d387.html`
- Hash: `ba39d387`
...
The `hx-ext` attribute enables an htmx <a href="https://htmx.org/extensions" rel="noopener" target="_blank">extension</a> for an element and all its children.
