# a-real-world-wasm-to-htmx-port__94fa4fe1

- Source URL: https://htmx.org/essays/a-real-world-wasm-to-htmx-port/
- Source file: `fetch/htmx_org_94fa4fe1.html`
- Hash: `94fa4fe1`
...
When I was in college, I wrote some customer service software that tied together some custom AI models I trained, the OpenAI API, a database, and some social media APIs to make the first version of <a href="https://sidekickai.co" rel="noopener" target="_blank">Sidekick</a>.

## <a href="#led-astray" class="zola-anchor" aria-label="Anchor link for: led-astray">Led astray</a>
...
## <a href="#a-better-way" class="zola-anchor" aria-label="Anchor link for: a-better-way">A better way</a>
...
## <a href="#reflection" class="zola-anchor" aria-label="Anchor link for: reflection">Reflection</a>
